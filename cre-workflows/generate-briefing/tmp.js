...
var onMissionStarted = (runtime2, log) => {
  ...
  runtime2.log(`MissionStarted: mission=${missionId}, player=${player}`);
  ...
  runtime2.log(`Player public key: ${publicKey.slice(0, 20)}...`);
  ...
  runtime2.log(`Scenario: "${scenario.title}"`);
...
`);
  runtime2.log(`Briefing generated (${briefingText.length} chars)`);
  runtime2.log(`--- BRIEFING START ---`);
  runtime2.log(briefingText);
  runtime2.log(`--- BRIEFING END ---`);
  return {};
};
