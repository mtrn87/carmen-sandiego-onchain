...
const MAP_LOCATIONS = [
    ...
    cases: [
      {
        ...
        type: 'NFT Theft',
        status: 'active',
        description: 'A high-value NFT was transferred to an unknown wallet and bridged to Polygon.',
  ...
  },
  {
    ...
    image: '/dubai.png',
    coords: { left: '57%', top: '40%' },
    cases: [
      {
        id: 'dubai-burj',
        name: 'Burj Khalifa Beacon',
        type: 'Monitoring Contract',
        status: 'active',
        description: 'A monitoring beacon deployed near the Burj Khalifa node. Bridge ingress detected from BNB Chain.',
        image: '/dubai_1.png',
      },
      {
        id: 'dubai-airport',
        name: 'Airport Custody Router',
        type: 'Custody Protocol',
        status: 'active',
        description: 'A custody router at the Dubai Airport node. High-value cross-chain asset arrival confirmed.',
        image: '/dubai_2.png',
      },
      {
        id: 'dubai-mall',
    ...
    cases: [
      {
        ...
        type: 'Bridge Relay',
        status: 'active',
        description: 'A bridge relay hidden near the ancient Senso-ji temple. Cross-chain asset ingress from Polygon detected.',
        image: '/tokyo_1.png',
      },
      {
        id: 'tokyo-tower',
