 ...
 */
export async function signRegistrationMessage(playerAddress, nickname) {
  // Get Privy's embedded wallet signer
  if (!window.ethereum) {
    throw new Error("No Ethereum provider found. Privy embedded wallet may not be initialized.");
  }
